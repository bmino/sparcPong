...
describe('player listing', function() {
    ...
    it('completes successfully', function() {
        return requester
            ...
            .then((res) => {
                ...
                expect(res.body.message).to.have.deep.members(TestUtils.getPlayers().filter(p => p.active));
            });
    });

    it('returns an empty list when no players exist', function() {
